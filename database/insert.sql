...
('very good','do more exercise','2019-04-09',4,'a','stomachache, headache', '2019-04-12', 1, 1, 2),
('nice','do more exercise','2015-05-05',5,'a','fever, chills', '2019-05-10', 2,2,5),
('very good','do more exercise','2017-06-010',3,'a','cough, headache', '2017-06-12', 3,3,10),
('nice','do more exercise','2017-02-01',4,'a','Shortness of breath or difficulty breathing', '2017-02-12', 4,4,1),
('very good','do more exercise','2020-04-03',5,'a','Muscle or body aches', '2020-04-12', 5,5,3),
('nice','do more exercise','2022-02-09',3,'a','Sore throat', '2022-02-12', 6,6,15),
('very good','do more exercise','2021-09-02',4,'a','Congestion or runny nose', '2021-09-12', 7,7,12),
('nice','do more exercise','2022-06-06',5,'a','Diarrhea', '2022-06-12', 8,8,14),
('very good','do more exercise','2022-04-03',3,'a','stomachache, headache', '2022-04-12', 9,9,7),
...
('very good','do more exercise','2019-10-09',4,'a','headache', '2019-10-12', 12, 1, 3),
...
('very good','do more exercise','2022-10-09',4,'a','Sore throat', '2022-10-12', 15, 3, 5),
('nice','do more exercise','2022-04-09',4,'a','Diarrhea', '2022-04-12', 16, 2, 2),
('very good','do more exercise','2022-11-09',4,'w','Sore throat', '2022-11-15', 17, 1, 7),
('very good','do more exercise','2021-09-02',4,'a','Congestion or runny nose', '2021-09-12', 18,2,12),
('very good','do more exercise','2022-04-03',3,'d','stomachache, headache', '2022-04-12', 19,1,6),
('nice','do more exercise','2022-04-03',3,'a','Congestion or runny nose', '2022-04-12', 20,1,8),
('very good','do more exercise','2020-04-03',5,'a','Muscle or body aches', '2020-04-12', 21,1,9),
('nice','do more exercise','2022-04-03',3,'a','Nausea or vomiting', '2022-04-12', 22,2,1),
('nice','do more exercise','2022-02-09',3,'w','Sore throat', '2022-02-12', 23,2,15),
('very good','do more exercise','2020-04-03',5,'a','Muscle or body aches', '2020-04-12', 24,2,14),
('nice','do more exercise','2022-02-09',3,'d','Sore throat', '2022-02-12', 25,2,13),
('nice','do more exercise','2022-04-03',3,'a','Nausea or vomiting', '2022-04-12', 25,2,12),
('very good','do more exercise','2021-09-02',4,'a','Congestion or runny nose', '2021-09-12', 26,2,11),
('very good','do more exercise','2017-06-010',3,'a','cough, headache', '2017-06-12', 27,2,10),
('nice','do more exercise','2022-06-06',5,'a','Diarrhea', '2022-06-12', 28,15,1),
('nice','do more exercise','2022-04-03',3,'a','Congestion or runny nose', '2022-04-12', 29,16,1),
('nice','do more exercise','2022-04-03',3,'a','Nausea or vomiting', '2022-04-12', 30,14,1),
('very good','do more exercise','2021-09-02',4,'a','Congestion or runny nose', '2021-09-12', 31,13,1),
('very good','do more exercise','2022-04-03',3,'d','stomachache, headache', '2022-04-12', 32,12,1),
('nice','do more exercise','2017-02-01',4,'a','Shortness of breath or difficulty breathing', '2017-02-12', 33,12,2),
('nice','do more exercise','2022-06-06',5,'a','Heart breaker', '2022-06-12', 34,11,2),
('nice','do more exercise','2022-06-06',5,'a','Diarrhea', '2022-06-12', 35,10,2),
('nice','do more exercise','2015-05-05',5,'a','fever, chills', '2019-05-10', 36,9,2),
