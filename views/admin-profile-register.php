...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/profile/request-doctor.css">
...
<body>
    ...
    <main>
        ...
        <div>
            <?php require_once("./profile-components/section-bar-ad-3.php") ?>
            <?php require_once("./profile-components/doctors-register-info.php") ?>
        </div>
