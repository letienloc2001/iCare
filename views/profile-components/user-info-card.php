...
<div class="user-card">
    ...
    <div>
        ...
        <?php 
            ...
            while($doc_spec = mysqli_fetch_assoc($result2)){
                $spec = $doc_spec['spec_name'];
            // echo "<div class='user-info'>Major: <span class='info'>$spec</span></div>";
            }
        ?>
        <div class='user-info'>Major: <span class='info'>$spec</span></div>
        <div class="user-info">Address: <span class="info"><?php echo $address ?></span></div>
        <div class="user-info">Contact: <span class="info">$username</span></div>
    </div>
</div>