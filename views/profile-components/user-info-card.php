<div class="user-card">
    <div class="user-image-card">
        <img class="user-image" src="../assets/img/mock/doc-pic-1.jpg" alt="">
    </div>
    <div>
        <div class="user-name">Nguyen Khuong Duy</div>
        ...
        <div class="user-info">Address: <span class="info">247/17A Lac Long Quan P3 Q11 asdadhjkahdjkhajhdjhasjdhjajhdjah</span></div>
