...
<div class="user-card">
    ...
    <div>
        ...
        <?php if($user_type == 'p') { ?>
        <button class="edit-button"><a href="./services/booking-process.php?doc_id=<?php echo $id ?>&pat_id=<?php echo $_SESSION['id'] ?>" class="edit-profile"> Request <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
